...
from bme.apps.swingtime.models import Event, Occurrence
from bme.apps.swingtime import utils, forms
from bme.apps.swingtime.views import *
from bme.apps.olwidget.widgets import MapDisplay
from bme.apps.brc.models import *
from bme.apps.brc import forms as brcforms
