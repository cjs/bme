...
from bme.apps.swingtime.models import Event
from datetime import datetime, timedelta

from django.core.urlresolvers import reverse

from bme.apps.checkins.models import CheckIn
...
class ThemeCamp(models.Model):
    ...
    def get_absolute_url(self):
        return ('bme.apps.brc.views.themecampid', (), {
...
class ArtInstallation(models.Model):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ('bme.apps.brc.views.art_installation_id', (), {
...
class PlayaEvent(Event):
  ...
  @models.permalink
  def get_absolute_url(self):
      return ('bme.apps.brc.views.playa_event_view', (), {
